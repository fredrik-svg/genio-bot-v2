...
echo "=================================================="
echo ""
echo "⚠️  VIKTIGT: Detta är för LOKAL utveckling och testning!"
echo "    För produktion används HiveMQ Cloud - ingen lokal"
echo "    MQTT broker installation behövs!"
echo ""
echo "💡  Rekommendation: Använd HiveMQ Cloud istället"
echo "    Se MQTT_QUICKSTART.md för instruktioner"
echo ""
read -p "Vill du fortsätta med lokal installation? (y/N): " -n 1 -r
echo ""
if [[ ! $REPLY =~ ^[Yy]$ ]]; then
    echo "Avbrutet. Se MQTT_QUICKSTART.md för HiveMQ Cloud setup"
    exit 0
fi
echo ""
...
echo "=================================================="
echo ""
echo "⚠️  Du kör nu en LOKAL testmiljö (endast för utveckling)"
echo ""
echo "Tjänster:"
echo "  • Mosquitto MQTT Broker:"
echo "    - MQTT: localhost:1883 (utan TLS)"
...
echo "     VIKTIGT: Använd 'localhost' som MQTT host, port 1883, TLS=false"
...
echo ""
echo "🚀 För produktionsanvändning: Använd HiveMQ Cloud istället!"
echo "   Se MQTT_QUICKSTART.md för instruktioner"
echo "=================================================="
